...
import { GlobalContextSelector, MDR_CONTEXT_ROUTES } from '@/features/clinical-context';
...
const BaseLayout = () => {
  ...
  // Check if we should show the GlobalContextSelector
  const showContextSelector = MDR_CONTEXT_ROUTES.some(route => pathname.startsWith(route));
  ...
  return (
    ...
    >
      {/* Global Context Selector - only show for MDR routes */}
      {showContextSelector && <GlobalContextSelector />}
