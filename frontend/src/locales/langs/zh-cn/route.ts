const route: App.I18n.Schema['translation']['route'] = {
  ...
  '(base)_mdr_global-library': '标准库',
  '(base)_mdr_mapping-studio': '映射工作室',
  '(base)_mdr_pipeline-management': '管线与项目管理',
  '(base)_mdr_pr-approval': 'PR 审批流',
  '(base)_mdr_programming-tracker': '编程任务跟踪',
  '(base)_mdr_study-spec': '项目规范',
  '(base)_mdr_tfl-designer': 'TFL 设计器',
  '(base)_mdr_tfl-template-library': '模板库',
  '(base)_mdr_tracker': '追踪看板',
