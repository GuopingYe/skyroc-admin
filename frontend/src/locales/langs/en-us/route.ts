const route: App.I18n.Schema['translation']['route'] = {
  ...
  '(base)_mdr': 'Clinical MDR',
  '(base)_mdr_global-library': 'Global Library',
  '(base)_mdr_mapping-studio': 'Mapping Studio',
  '(base)_mdr_pipeline-management': 'Pipeline Management',
  '(base)_mdr_pr-approval': 'PR Approval',
  '(base)_mdr_programming-tracker': 'Programming Tracker',
  '(base)_mdr_study-spec': 'Study Spec',
  '(base)_mdr_tfl-designer': 'TFL Designer',
  '(base)_mdr_tfl-template-library': 'Template Library',
  '(base)_mdr_tracker': 'Tracker',
  ...
  '(base)_system': 'System Governance',
  '(base)_system_reference-data': 'Reference Data',
  '(base)_system_role-permission': 'Role Permission',
  '(base)_system_user-management': 'User Management',
