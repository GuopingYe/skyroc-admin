...
/** Checks if store items need to be updated with fetched items. Uses ID comparison to detect changes. */
export function needsSync<T extends { id: string }>(fetchedItems: T[], storeItems: T[]): boolean {
