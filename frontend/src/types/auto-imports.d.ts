...
declare global {
  ...
  const ADAM_STRUCTURE_CONFIG: typeof import('antd')['DAM_STRUCTURE_CONFIG']
  ...
  const DataSkeleton: typeof import('../components/Skeleton/index')['DataSkeleton']
  ...
  const PermissionGuard: typeof import('../components/PermissionGuard')['default']
  ...
  const TableSkeleton: typeof import('../components/Skeleton/index')['TableSkeleton']
  ...
  const useUserPermissions: typeof import('../hooks/business/useUserPermissions')['default']
  ...
  const withPermission: typeof import('../components/PermissionGuard')['withPermission']
}
// for type re-export
declare global {
  // @ts-ignore
