    ...
    children: [
      {
        ...
        children: [
          ...
          {
            matchedFiles: [null, '/src/pages/(base)/mdr/index.tsx', null, null],
            name: '(base)_mdr',
            path: '/mdr',
            handle: { i18nKey: 'route.(base)_mdr', icon: 'mdi:database-cog', order: 2, title: 'Clinical MDR' },
            children: [
              {
                matchedFiles: [null, '/src/pages/(base)/mdr/global-library/index.tsx', null, null],
                name: '(base)_mdr_global-library',
                path: '/mdr/global-library',
                handle: { i18nKey: 'route.(base)_mdr_global-library', title: '(base)_mdr_global-library' }
              },
              {
                matchedFiles: [null, '/src/pages/(base)/mdr/mapping-studio/index.tsx', null, null],
                name: '(base)_mdr_mapping-studio',
                path: '/mdr/mapping-studio',
                handle: {
                  i18nKey: 'route.(base)_mdr_mapping-studio',
              ...
              {
                matchedFiles: [null, '/src/pages/(base)/mdr/pipeline-management/index.tsx', null, null],
                name: '(base)_mdr_pipeline-management',
                path: '/mdr/pipeline-management',
                handle: { i18nKey: 'route.(base)_mdr_pipeline-management', title: '(base)_mdr_pipeline-management' }
              },
              {
                matchedFiles: [null, '/src/pages/(base)/mdr/pr-approval/index.tsx', null, null],
                name: '(base)_mdr_pr-approval',
                path: '/mdr/pr-approval',
                handle: {
                  i18nKey: 'route.(base)_mdr_pr-approval',
              ...
              {
                matchedFiles: [null, '/src/pages/(base)/mdr/programming-tracker/index.tsx', null, null],
                name: '(base)_mdr_programming-tracker',
                path: '/mdr/programming-tracker',
                handle: { i18nKey: 'route.(base)_mdr_programming-tracker', title: '(base)_mdr_programming-tracker' }
              },
              {
                matchedFiles: [null, '/src/pages/(base)/mdr/study-spec/index.tsx', null, null],
                name: '(base)_mdr_study-spec',
                path: '/mdr/study-spec',
              ...
              },
              {
                ...
                name: '(base)_mdr_tracker',
                path: '/mdr/tracker',
                handle: {
                  i18nKey: 'route.(base)_mdr_tracker',
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                handle: { i18nKey: 'route.(base)_system_role-permission', title: '(base)_system_role-permission' }
              },
              {
                matchedFiles: [null, '/src/pages/(base)/system/user-management/index.tsx', null, null],
                name: '(base)_system_user-management',
