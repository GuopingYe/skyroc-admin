...
"(base)_mdr_global-library": () => import("@/pages/(base)/mdr/global-library/index.tsx"),
"(base)_mdr": () => import("@/pages/(base)/mdr/index.tsx"),
"(base)_mdr_mapping-studio": () => import("@/pages/(base)/mdr/mapping-studio/index.tsx"),
"(base)_mdr_pipeline-management": () => import("@/pages/(base)/mdr/pipeline-management/index.tsx"),
"(base)_mdr_pr-approval": () => import("@/pages/(base)/mdr/pr-approval/index.tsx"),
"(base)_mdr_programming-tracker": () => import("@/pages/(base)/mdr/programming-tracker/index.tsx"),
"(base)_mdr_study-spec": () => import("@/pages/(base)/mdr/study-spec/index.tsx"),
"(base)_mdr_tfl-designer": () => import("@/pages/(base)/mdr/tfl-designer/index.tsx"),
"(base)_mdr_tfl-template-library": () => import("@/pages/(base)/mdr/tfl-template-library/index.tsx"),
"(base)_mdr_tracker": () => import("@/pages/(base)/mdr/tracker/index.tsx"),
...
"(base)_system_reference-data": () => import("@/pages/(base)/system/reference-data/index.tsx"),
"(base)_system_role-permission": () => import("@/pages/(base)/system/role-permission/index.tsx"),
"(base)_system_user-management": () => import("@/pages/(base)/system/user-management/index.tsx"),
